...
f=Image+(sob_image_+sob_image+sob_image_t+sob_image_t_)/1.5;

s=rectMF(f,m,Info);

stan=standard(s,Info);

imwrite(uint8(to_ewl(stan,Info)), 'C:\Users\Sebastian\Desktop\OUT_DR1.bmp')
